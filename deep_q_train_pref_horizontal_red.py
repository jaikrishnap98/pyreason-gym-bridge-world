...
class LegalBridgeDQL():
    ...
    def test(self, episodes, test_set, model='bridge_world_dql_pref_horizontal_red.pt'):
        #
...
if __name__ == '__main__':
    ...
    train_set = []
    test_set = [1, 4, 12, 22, 35, 43, 49, 55, 61, 66, 68, 74, 80, 85, 90, 93, 95, 96, 98, 99, 101, 104, 114, 118, 119, 120, 122, 126, 128, 134, 135, 136, 143, 146, 154, 166,
